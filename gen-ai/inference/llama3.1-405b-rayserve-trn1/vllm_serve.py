...
@serve.deployment(name="vllm", route_prefix="/vllm",
                  ray_actor_options={"resources": {"neuron_cores": 32},"runtime_env": {"env_vars": {"NEURON_CC_FLAGS": "-O1"}}},
...
class VLLMDeployment:
    def __init__(self, **kwargs):
        ...
        args = AsyncEngineArgs(
            model=os.getenv("MODEL_ID", "meta-llama/Meta-Llama-3.1-405B-Instruct"),  # Model identifier from Hugging Face Hub or local path.
            ...
            tensor_parallel_size=32,  # Number of tensor parallelism stages; typically set to 1 unless using model parallelism.
    ...
    async def __call__(self, request: Request) -> Response:
        ...
        if context_length not in [8192, 32768, 131072]:
            context_length = 131072  # Default to 8k if invalid
