...
model_id = os.getenv('MODEL_ID', "meta-llama/Meta-Llama-3.1-405B")
neuron_cores = 32  # inf2.24xlarge 6 Neurons (12 Neuron cores) and inf2.48xlarge 12 Neurons (24 Neuron cores)
